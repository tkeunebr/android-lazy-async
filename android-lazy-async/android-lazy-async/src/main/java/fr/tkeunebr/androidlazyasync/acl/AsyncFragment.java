package fr.tkeunebr.androidlazyasync.acl;
 ...
 * This version is here if you are working with the Android Support Library.
 */
public abstract class AsyncFragment extends Fragment {
     ...
     * it if necessary.
     *
     * @param fm    the {@link android.app.FragmentManager}
     ...
     * These callbacks will be propagated to the {@link Activity} or {@link android.app.Fragment}
     * owner.
     */
    ...
    /**
     * Interface used to propagate messages to the {@link android.app.Fragment}
